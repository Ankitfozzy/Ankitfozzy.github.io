...
// *=============================== github calender ==================================
GitHubCalendar(".calendar", "Ankitfozzy");

// or enable responsive functionality:
GitHubCalendar(".calendar", "Ankitfozzy", { responsive: true });
...
const typed = new Typed('.multiple-text', {
  strings: ['Full Stack Web Developer','Backend Developer','Yoga Instructor'],
  typeSpeed: 100,
  backSpeed: 100,
  backdelay: 1000,
  loop: true,
